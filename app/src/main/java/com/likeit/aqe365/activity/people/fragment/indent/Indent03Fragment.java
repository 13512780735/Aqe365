...
import com.likeit.aqe365.activity.people.adapter.GoodIndent03Adapter;
...
public class Indent03Fragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initData(int pageNum, final boolean isloadmore) {
        ...
        RetrofitUtil.getInstance().Orderform(token, signature, newtime, random, "2", String.valueOf(pageNum), new Subscriber<BaseResponse<IndentListModel>>() {
            @Override
